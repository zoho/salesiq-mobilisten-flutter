...
- Added iOS UIScene (SceneDelegate) lifecycle support; notification-launch handling now also works in scene-based apps. Legacy AppDelegate-only apps keep working unchanged.
